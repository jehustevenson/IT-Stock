          ...
          <form onSubmit={handleSubmit(onFormSubmit)} className="card p-6 space-y-6">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400 mb-3">
                Fill these fields if the asset is already with a staff member. This will set the status to Assigned.
              </p>
            ...
            <div>
              ...
              <p className="form-helper -mt-0.5 mb-1">Repair status, condition, or special instructions</p>
              <textarea
                {...register('notes')}
                rows={3}
